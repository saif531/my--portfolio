       ...
       <div className="container px-5 py-24 mx-auto">
         <div className="flex flex-col">
           ...
           <div className="flex flex mx-auto mt-16 sm:flex-row flex-col py-6 mb-12">
             <h1 className="sm:w-2/5 text-white font-medium title-font text-2xl mb-2 sm:mb-0">Saifullah Zain</h1>
             <p className="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">I am expert in these languages</p>
           </div>
         </div>
       </div>
     </section>
     ...
     <header className="text-gray-400 bg-gray-900 body-font">
       <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
         <a className="flex title-font font-medium items-center text-white mb-4 md:mb-0">
           ...
           <span className="ml-3 flex mx-auto mt-16 text-xl">Programming Languages</span>
         </a>
         <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700	flex flex mx-auto mt-16 items-center text-base justify-center">
           <a className="mr-5 hover:text-white"><VscVscode className="flex bg-white-500 text-sky-500 text-6xl" /></a>
           <a className="mr-5 hover:text-white"><FaHtml5 className="text-sky-500 text-6xl" /></a>
           <a className="mr-5 hover:text-white"><FaCss3Alt className="text-sky-500 text-6xl" /></a>
           <a className="mr-5 hover:text-white"><IoLogoJavascript className="text-sky-500 text-6xl" /></a>
           <a className="mr-5 hover:text-white"><IoLogoPython className="text-sky-500 text-6xl" /></a>
         </nav>
       </div>
     </header>
